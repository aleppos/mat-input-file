...
@Component({
  ...
  styleUrls: ['./mat-input-file.component.css'],
  providers: [
    { provide: MatFormFieldControl, useExisting: MatInputFileComponent }
  ]
})
export class MatInputFileComponent implements OnInit, OnDestroy, MatFormFieldControl<FileInput>, ControlValueAccessor {
  ...
  @HostBinding() id = `mat-input-file-${MatInputFileComponent.nextId++}`;
